...
class CreateMaeHorarioAtencionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mae_horario_atencions', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('mae_horario_atencions');
    }
}
